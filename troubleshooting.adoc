...
* Un problema común que podrías encontrar al usar Trident con https://azure.microsoft.com/en-us/services/netapp/["Azure NetApp Files"] es cuando los secretos de tenant y client vienen de un registro de app con permisos insuficientes. Para ver una lista completa de los requisitos de Trident, consulta link:trident-use/anf.html["Azure NetApp Files"] configuration.
