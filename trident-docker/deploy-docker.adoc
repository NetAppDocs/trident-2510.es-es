...
.Lo que necesitas
Consulta link:prereqs-docker.html["requisitos previos para el despliegue"]. Después de asegurarte de que se cumplen los requisitos previos, ya puedes desplegar Trident.
