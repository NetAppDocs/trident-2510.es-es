...
summary: Se necesitan varias instancias de Trident cuando quieres tener varias configuraciones de almacenamiento disponibles al mismo tiempo. La clave para tener varias instancias es darles nombres diferentes usando la opción --alias con el plugin en contenedor, o la opción --volume-driver al instanciar Trident en el host. 
---
