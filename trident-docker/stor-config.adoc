...
Para obtener información sobre FlexGroups y las cargas de trabajo que son adecuadas para FlexGroups, consulta la  https://www.netapp.com/pdf.html?item=/media/12385-tr4571pdf.pdf["NetApp FlexGroup volume Guía de mejores prácticas e implementación"^].
