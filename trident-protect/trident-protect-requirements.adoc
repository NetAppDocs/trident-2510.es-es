...
* Asegúrate de que existe al menos un VolumeSnapshotClass. Para más información, consulta link:https://docs.netapp.com/us-en/trident_main/trident-reference/objects.html#kubernetes-volumesnapshotclass-objects["VolumeSnapshotClass"].
...
* *Cluster y SVM*: Los backends de almacenamiento ONTAP deben ser peered. Consulta https://docs.netapp.com/us-en/ontap/peering/index.html["Descripción general de clúster y SVM peering"^] para más información.
+
