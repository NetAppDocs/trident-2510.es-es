...
summary: 'El bucket custom resource (CR) para Trident Protect se conoce como un AppVault. AppVaults son la representación declarativa del flujo de trabajo de Kubernetes de un bucket de almacenamiento.' 
---
