...
summary: 'Trident Protect utiliza el modelo de Kubernetes de control de acceso basado en roles (RBAC). Puedes usar las funciones RBAC de Trident Protect para controlar de forma más precisa el acceso a los recursos.' 
---
