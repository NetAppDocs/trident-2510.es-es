...
+
Una vez finalizada la instalación, el Operator aparece en la lista de operadores instalados y está listo para usar.

. Haz clic en *Ver operador* para ver los detalles del operador.
+
image::../media/openshift-operator-04.png[Instalado]

. En *Trident Orchestrator*, haz clic en *Crear instancia*.
+
