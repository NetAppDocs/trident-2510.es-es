...
* Asegúrate de que la desconexión forzada esté habilitada antes de habilitar la conmutación automática al respaldo. Para más información, consulta <<Detalles sobre la desconexión forzada>>.
