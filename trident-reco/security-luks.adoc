...
NOTE: El cifrado LUKS no es compatible con sistemas ASA r2. Para obtener información sobre sistemas ASA r2, consulta link:https://docs.netapp.com/us-en/asa-r2/get-started/learn-about.html["Conoce los sistemas de almacenamiento ASA r2"^].
