...
NOTE: _Si bien Trident es compatible con Rancher Kubernetes Engine 2 (RKE2) versiones 1.27.x - 1.34.x, Trident actualmente solo ha sido calificado en RKE2 v1.28.5+rke2r1._
