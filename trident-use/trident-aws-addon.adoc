...
. Asegúrate de crear un rol de IAM y un secreto de AWS para que los pods de EKS puedan acceder a los recursos de AWS. Para obtener instrucciones, consulta link:../trident-use/trident-fsx-iam-role.html["Crea un rol de IAM y un secreto de AWS"^].
...
----
. Continúa con la configuración y configura el backend de almacenamiento. Para más información, consulta link:../trident-use/trident-fsx-storage-backend.html["Configura el backend de almacenamiento"^].
