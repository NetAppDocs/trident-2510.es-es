...
NOTE: Después de ejecutar este comando, ONTAP solicita la introducción del certificado. Pega el contenido del archivo `k8senv.pem` generado en el paso 1, luego ingresa `END` para completar la instalación.
