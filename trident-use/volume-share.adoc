...
* Visita link:https://cloud.netapp.com/blog/astra-blg-sharing-volumes-between-namespaces-say-hello-to-cross-namespace-volume-access["Compartir volúmenes entre espacios de nombres: di hola al acceso a volúmenes entre espacios de nombres"^].
