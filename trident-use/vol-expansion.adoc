...
summary: Trident les da a los usuarios de Kubernetes la posibilidad de ampliar sus volúmenes después de que se crean. Encuentra información sobre las configuraciones necesarias para ampliar volúmenes iSCSI, FC y NFS. 
---
= Ampliar volúmenes
:hardbreaks:
:allow-uri-read: 
