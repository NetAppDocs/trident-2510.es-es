...
.Pasos
* Crea un VolumeGroupSnapshotClass antes de crear un VolumeGroupSnapshot. Para más información, consulta link:../trident-reference/objects.html#kubernetes-volumegroupsnapshotclass-objects["VolumeGroupSnapshotClass"].
+
[source, yaml]
----
