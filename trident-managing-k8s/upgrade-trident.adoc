...
** Para más información, consulta link:../trident-rn.html["Problemas conocidos"].
...
* Si estás actualizando desde una versión fuera del periodo de cuatro versiones, haz una actualización en varios pasos. Usa las instrucciones de actualización para la link:../earlier-versions.html["versión anterior"] de la que estás actualizando para pasar a la versión más reciente que entre en el periodo de cuatro versiones. Por ejemplo, si estás usando la versión 23.07 y quieres actualizar a la 25.06:
+
...
Generalmente, deberías actualizar usando el mismo método que usaste para la instalación inicial, aunque puedes link:../trident-get-started/kubernetes-deploy.html#moving-between-installation-methods["moverse entre métodos de instalación"]. Hay dos opciones para actualizar Trident.
