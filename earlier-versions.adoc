...
summary: Puedes usar el selector de versiones para navegar entre la última versión y las cuatro anteriores o usar los enlaces que aparecen abajo. 
---
...
[role="lead"]
Si no estás ejecutando Trident 25.10, la documentación de las versiones anteriores está disponible según el link:get-help.html["Ciclo de vida de soporte de Trident"].
